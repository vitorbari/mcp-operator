...
import (
	...
	gatewayv1 "github.com/vitorbari/mcp-operator/api/v1"
)
...
// +kubebuilder:rbac:groups=gateway.mcp-operator.io,resources=mcpservers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=gateway.mcp-operator.io,resources=mcpservers/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=gateway.mcp-operator.io,resources=mcpservers/finalizers,verbs=update
...
const (
	mcpServerFinalizer = "gateway.mcp-operator.io/finalizer"
	defaultPort        = 8080
...
func (r *MCPServerReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if mcpServer.Status.Phase == "" {
		mcpServer.Status.Phase = gatewayv1.MCPServerPhaseCreating
...
func (r *MCPServerReconciler) handleDeletion(ctx context.Context, mcpServer *gatewayv1.MCPServer) (ctrl.Result, error) {
	log := logf.FromContext(ctx)

	// Update status to Terminating
	mcpServer.Status.Phase = gatewayv1.MCPServerPhaseTerminating
...
func (r *MCPServerReconciler) reconcileServiceAccount(ctx context.Context, mcpServer *gatewayv1.MCPServer) error {
...
func (r *MCPServerReconciler) reconcileRBAC(ctx context.Context, mcpServer *gatewayv1.MCPServer) error {
...
func (r *MCPServerReconciler) reconcileDeployment(ctx context.Context, mcpServer *gatewayv1.MCPServer) error {
...
func (r *MCPServerReconciler) buildDeployment(mcpServer *gatewayv1.MCPServer) *appsv1.Deployment {
	replicas := int32(1)
	...
	// Add pod template specifications
	if mcpServer.Spec.PodTemplate != nil {
		if mcpServer.Spec.PodTemplate.NodeSelector != nil {
			podSpec.NodeSelector = mcpServer.Spec.PodTemplate.NodeSelector
		}
		if len(mcpServer.Spec.PodTemplate.Tolerations) > 0 {
			podSpec.Tolerations = mcpServer.Spec.PodTemplate.Tolerations
		}
		if mcpServer.Spec.PodTemplate.Affinity != nil {
			podSpec.Affinity = mcpServer.Spec.PodTemplate.Affinity
		}
		if mcpServer.Spec.PodTemplate.ServiceAccountName != "" {
			podSpec.ServiceAccountName = mcpServer.Spec.PodTemplate.ServiceAccountName
		}
		if len(mcpServer.Spec.PodTemplate.ImagePullSecrets) > 0 {
			podSpec.ImagePullSecrets = mcpServer.Spec.PodTemplate.ImagePullSecrets
		}
		if len(mcpServer.Spec.PodTemplate.Volumes) > 0 {
			podSpec.Volumes = mcpServer.Spec.PodTemplate.Volumes
		}
	}
...
func (r *MCPServerReconciler) reconcileService(ctx context.Context, mcpServer *gatewayv1.MCPServer) error {
...
func (r *MCPServerReconciler) buildService(mcpServer *gatewayv1.MCPServer) *corev1.Service {
	labels := map[string]string{
		"app":                          mcpServer.Name,
		"app.kubernetes.io/name":       "mcpserver",
		"app.kubernetes.io/instance":   mcpServer.Name,
...
func (r *MCPServerReconciler) getServicePort(mcpServer *gatewayv1.MCPServer) int32 {
...
func (r *MCPServerReconciler) reconcileHPA(ctx context.Context, mcpServer *gatewayv1.MCPServer) error {
...
func (r *MCPServerReconciler) buildHPA(mcpServer *gatewayv1.MCPServer) *autoscalingv2.HorizontalPodAutoscaler {
	labels := map[string]string{
		"app":                          mcpServer.Name,
		"app.kubernetes.io/name":       "mcpserver",
		"app.kubernetes.io/instance":   mcpServer.Name,
...
func (r *MCPServerReconciler) buildHPAScalingRules(behavior *gatewayv1.MCPServerHPABehavior) *autoscalingv2.HPAScalingRules {
...
func (r *MCPServerReconciler) updateStatus(ctx context.Context, mcpServer *gatewayv1.MCPServer) error {
...
func (r *MCPServerReconciler) updateStatusWithError(ctx context.Context, mcpServer *gatewayv1.MCPServer, err error) (ctrl.Result, error) {
	mcpServer.Status.Phase = gatewayv1.MCPServerPhaseFailed
	mcpServer.Status.Message = fmt.Sprintf("Error: %v", err)

	// Update conditions
	condition := gatewayv1.MCPServerCondition{
		Type:               gatewayv1.MCPServerConditionReconciled,
...
func (r *MCPServerReconciler) updateMCPServerStatus(ctx context.Context, mcpServer *gatewayv1.MCPServer) error {
	...
	if deployment.Status.Replicas == 0 {
		...
		if deployment.Status.UpdatedReplicas < deployment.Status.Replicas {
			mcpServer.Status.Phase = gatewayv1.MCPServerPhaseUpdating
			mcpServer.Status.Message = "Rolling out update"
		} else {
			mcpServer.Status.Phase = gatewayv1.MCPServerPhaseScaling
			mcpServer.Status.Message = "Scaling deployment"
		}
	} else {
		mcpServer.Status.Phase = gatewayv1.MCPServerPhaseRunning
...
func (r *MCPServerReconciler) updateConditions(mcpServer *gatewayv1.MCPServer, deployment *appsv1.Deployment) {
	now := metav1.Now()

	// Ready condition
	readyCondition := gatewayv1.MCPServerCondition{
		Type:               gatewayv1.MCPServerConditionReady,
	...
	// Available condition
	availableCondition := gatewayv1.MCPServerCondition{
		Type:               gatewayv1.MCPServerConditionAvailable,
		LastTransitionTime: now,
	}
	...
	progressingCondition := gatewayv1.MCPServerCondition{
		Type:               gatewayv1.MCPServerConditionProgressing,
		LastTransitionTime: now,
	}
	...
	reconciledCondition := gatewayv1.MCPServerCondition{
		Type:               gatewayv1.MCPServerConditionReconciled,
...
func (r *MCPServerReconciler) setCondition(mcpServer *gatewayv1.MCPServer, newCondition gatewayv1.MCPServerCondition) {
