...
var _ = Describe("MCPServer Controller", func() {
	Context("When reconciling a basic MCPServer", func() {
		...
		var mcpserver *gatewayv1.MCPServer
		...
		BeforeEach(func() {
			...
			mcpserver = &gatewayv1.MCPServer{
				...
				Spec: gatewayv1.MCPServerSpec{
					...
					Security: &gatewayv1.MCPServerSecurity{
		...
		BeforeEach(func() {
			...
			mcpserver = &gatewayv1.MCPServer{
				...
				Spec: gatewayv1.MCPServerSpec{
					...
					Service: &gatewayv1.MCPServerService{
						Type:       "ClusterIP",
						Port:       9090,
						TargetPort: &intstr.IntOrString{IntVal: 80},
					},
					HealthCheck: &gatewayv1.MCPServerHealthCheck{
						Enabled:             ptr(true),
						Path:                "/health",
