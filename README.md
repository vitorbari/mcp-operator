...
```yaml
apiVersion: gateway.mcp-operator.io/v1
kind: MCPServer
metadata:
  name: my-mcp-server
  namespace: default
...
This project is licensed under the Business Source License 1.1. See [LICENSE](LICENSE) file for details.

### License Summary

- ✅ **Free for internal organizational use**
- ✅ **Development, testing, and evaluation**
- ❌ **Commercial restrictions apply for hosted services**
